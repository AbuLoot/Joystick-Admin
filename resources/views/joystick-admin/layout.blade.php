      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li @if (Request::is('admin/apps', 'admin/apps/*')) class="active" @endif> <a href="/admin/apps"><i class="material-icons md-18">check</i> Заявки</a> </li>
          </ul>
          <ul class="nav nav-sidebar">
            ...
            <li @if (Request::is('admin/roles', 'admin/roles/*')) class="active" @endif> <a href="/admin/roles"><i class="material-icons md-18">lock_outline</i> Роли</a> </li>
            <li @if (Request::is('admin/permissions', 'admin/permissions/*')) class="active" @endif> <a href="/admin/permissions"><i class="material-icons md-18">accessibility</i> Права доступа</a> </li>
          </ul>
        </div>
